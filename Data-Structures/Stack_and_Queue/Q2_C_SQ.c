...
{
    // Todo: 연결 리스트의 값을 이용해 스택을 구성하세요.
    // 문제의 스택 순서가 맞도록 push를 활용하고, 스택 내부 연결 리스트와 size가 올바르게 설정되도록 하세요.
    /* 여기에 코드를 작성하세요 */
}
void removeEvenValues(Stack *s)
{
	// Todo: 스택에서 짝수 값만 제거하세요.
	// 제거 후 남은 원소들의 순서가 문제 의도에 맞게 유지되도록 보조 스택 또는 적절한 로직을 사용하세요.
	/* 여기에 코드를 작성하세요 */
}
